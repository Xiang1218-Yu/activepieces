...
import { AddReplayOfRunIdToFlowRunSqlite1766000000000 } from './migration/sqlite/1766000000000-AddReplayOfRunIdToFlowRunSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddReplayOfRunIdToFlowRunSqlite1766000000000,
    ]
