...
import { AddWebhookRequestCaptureSqlite1842000000001 } from './migration/sqlite/1842000000001-AddWebhookRequestCaptureSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddWebhookRequestCaptureSqlite1842000000001,
    ]
