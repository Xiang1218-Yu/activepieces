...
import { AddGitPushOperationTable1842000000000 } from './migration/postgres/1842000000000-AddGitPushOperationTable'
import { AddReleaseContextToGitPushOperation1843000000000 } from './migration/postgres/1843000000000-AddReleaseContextToGitPushOperation'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddGitPushOperationTable1842000000000,
        AddReleaseContextToGitPushOperation1843000000000,
    ]
    return migrations
}
