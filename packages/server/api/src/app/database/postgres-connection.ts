...
import { AddChatHistoryIndexAndArchive1842000000000 } from './migration/postgres/1842000000000-AddChatHistoryIndexAndArchive'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddChatHistoryIndexAndArchive1842000000000,
    ]
    return migrations
}
