...
import { AddLastValidatedAtToAppConnection1842000000000 } from './migration/postgres/1842000000000-AddLastValidatedAtToAppConnection'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddLastValidatedAtToAppConnection1842000000000,
    ]
    return migrations
}
