...
const statusCodeMap: Partial<Record<ErrorCode, StatusCodes>> = {
    ...
    [ErrorCode.GIT_REPO_NOT_CONFIGURED]: StatusCodes.NOT_FOUND,
    [ErrorCode.GIT_PUSH_IN_PROGRESS]: StatusCodes.CONFLICT,
    [ErrorCode.GIT_PUSH_CONFLICT]: StatusCodes.CONFLICT,
    [ErrorCode.GIT_PUSH_FAILED]: StatusCodes.BAD_GATEWAY,
